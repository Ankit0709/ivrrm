...
<head>
	...
	<!-- AIVM-->
	<link rel="shortcut icon" href="img/aivm2.png">
	<!-- Author Meta -->
    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light main_box">
            <div class="container">
                ...
                <a class="navbar-brand logo_h" href="index.html"><img src="img/aivm2.png" alt="AIVM" style="width:100px;height:50px"></a>
                    ...
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item submenu dropdown">
                         ...
                         <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="nav-link" href="vendor_login.html">Login</a></li>
